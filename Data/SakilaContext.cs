...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ActorId).HasName("PK__actor__8B2447B4BA036812");
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__address__CAA247C87A109986");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__category__D54EE9B429445167");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A84A327BA0");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD0550D786043");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB854156A5A1");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film__349764A991B29C11");
        ...
        {
            entity.HasKey(e => new { e.ActorId, e.FilmId }).HasName("PK__film_act__086D31FEA1FE1D82");
        ...
        {
            entity.HasKey(e => new { e.FilmId, e.CategoryId }).HasName("PK__film_cat__69C38A32211CD3ED");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film_tex__349764A9E45B3194");
        ...
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__inventor__B59ACC49DB29787D");
        ...
        {
            entity.HasKey(e => e.LanguageId).HasName("PK__language__804CF6B353F966CE");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payment__ED1FC9EA261751CD");
        ...
        {
            entity.HasKey(e => e.RentalId).HasName("PK__rental__67DB611B350431CF");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staff__1963DD9C9BFF8884");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__store__A2F2A30C86DE0A52");
